...
<body onload="Timer()" style="background-color:#000000;">
  ...
  <div style="display:none;" id="Page" class="animate-page">
    ...
    <p class="text-center text-white Sharkloading_text">Det är magiskt!</p>

    <div class="alert alert-success sticky-top" id="success-alert" role="alert">
      Din lastningsskärm har skapats ! <a href="../loadingscreen.html" class="alert-link">Klicka här för att komma åt din lastningsskärm.</a>
    ...
    <div class="alert alert-danger" style="weight: 20%;" id="error-alert" role="alert">
      <a>Du fyllde inte fälten ordentligt !</a>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
    <script>
      $("#error-alert").hide();
    ...
    <div class="mx-auto w-50 p-3 bg-white rounded" style="height: 200px;">
      <h2 class="text-center text-dark Sharkloading_text">Vill du skapa en lastningsskärm ?</h2><br>
    ...
    <form method="post">
      <div id="etape1" class="mx-auto w-50 p-3 bg-white rounded animate-page" style="display:none; height: 280px;">
        <h2 class="text-center text-dark Sharkloading_text">Vad heter servern ?</h2><br>
        <input type="text" class="form-control mx-auto" style="height: 50px;" name="subject1" id="subject1" placeholder="Exempel: Sharkland"><br>
        <div class="input-group mb-3">
          <div class="input-group-prepend">
            <label class="input-group-text">Vad kommer att färgen på texten</label>
          </div>
          <select class="custom-select" name="couleur">
            <option value="text-dark">Svart</option>
            <option value="text-white">Vit</option>
            <option value="text-secondary">Grå</option>
            <option value="text-success">Grön</option>
            <option value="text-primary">Blå</option>
            <option value="text-danger">Röda</option>
          </select>
        </div>
        <button onclick="Etape('subject1','etape2');" style="margin-left: 47.5%;" type="button" class="btn btn-success text-center Sharkloading_text">Validera</button>
      </div><br>

      <div id="etape2" class="mx-auto w-50 p-3 bg-white rounded animate-page" style="display:none; height: 220px;">
        <h2 class="text-center text-dark Sharkloading_text">Vill du ta med en beskrivning?</h2><br>
        <input id="subject2" type="text" class="form-control mx-auto" style="height: 50px; display:none;" name="subject2" placeholder="Exempel: Inget att säga"><br>
        <button id="bouton2" onclick="Etape('subject2','etape3'); Scroll('etape3');" style="margin-left: 47.5%; display:none;" type="button" class="btn btn-success text-center Sharkloading_text">Validera</button>
        ...
        <button id="Non" onclick="Get('etape2','etape3')" style="margin-left: 42.5%;" type="button" class="btn btn-danger text-center Sharkloading_text">Inte</button>
      </div><br>

      <div id="etape3" class="mx-auto w-50 p-3 bg-white rounded animate-page" style="display:none; height: 220px;">
        <h2 class="text-center text-dark Sharkloading_text">Vill d inkludera en logotyp?</h2><br>
        <input id="logo" type="text" class="form-control mx-auto" style="height: 50px; display:none;" name="logo" placeholder="Exempel: https://image.com/image.jpg"><br>
        <button id="bouton3" onclick="Etape('logo','etape4'); Scroll('etape4');" style="margin-left: 47.5%; display:none;" type="button" class="btn btn-success text-center Sharkloading_text">Validera</button>
        ...
        <button id="Non2" onclick="Get('etape3','etape4')" style="margin-left: 42.5%;" type="button" class="btn btn-danger text-center Sharkloading_text">Inte</button>
      </div><br>

      <div id="etape4" class="mx-auto w-50 p-3 bg-white rounded animate-page" style="display:none; height: 220px;">
        <h2 class="text-center text-dark Sharkloading_text">Bakgrund :</h2><br>
        ...
        <button onclick="Etape('etape4','validation'); Scroll('validation');" style="margin-left: 47.5%;" type="button" class="btn btn-success text-center Sharkloading_text">Validera</button>
      </div><br>

      <div id="validation" class="mx-auto w-50 p-3 bg-white rounded animate-page" style="display:none; height: 220px;">
        <h2 class="text-center text-dark Sharkloading_text">Vill du validera skapandet av din lastningsskärm ?</h2><br>
