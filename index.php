...
<div style="display:none;" id="Page" class="animate-page">
  ...
  <h2 class="text-center text-dark Sharkloading_text">Quel est le nom de votre serveur ?</h2><br>
...
function Etape(subject,etape){
  ...
  if (input === "") {
    $("#error-alert").show();
    setTimeout(function(){ $("#error-alert").fadeOut(5000); }, 5000);
    return false;
  }
...
?>
      <script type="text/javascript">
        $("#success-alert").show();
        setTimeout(function(){ $("#success-alert").fadeOut(5000); }, 10000);
      </script>
<?php
